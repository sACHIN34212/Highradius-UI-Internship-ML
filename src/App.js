    ...
    <div className="App">
        ...
        <div className='btn-group' style={{ marginLeft: 10}}>
          <ButtonGroup style={{
            ...
            <Button style={{ background: "#87CEEB", width:"180px",color:'white' }}>PREDICT</Button>
            <Button style={{width:"180px" ,color:'white' }}>ANALYTICS VIEW</Button>
            <Button style={{width:"180px",color:'white' }} onClick={handleAdvanceSearchOpen}>ADVANCE SEARCH</Button>
          </ButtonGroup>
          ...
          <ButtonGroup style={Style}  variant="outlined" aria-label="outlined button group">
            <Button style={{width:"150px",color:'white' }} onClick={handleAddOpen}>ADD</Button>
            <Button style={{width:"150px", borderColor:"black" , margin:"0px 5px",color:'white' }} onClick={handleEditOpen}>EDIT</Button>
            <Button style={{width:"150px",color:'white' ,color:'white' }} onClick={handleDeleteOpen}>DELETE</Button>
          </ButtonGroup>
